...
const DisplayProfile= ({editProfile, switchMode}) => {
    ...
    return (
      <div>
        ...
        <section>
            <article><img src="https://media.istockphoto.com/photos/businessman-silhouette-as-avatar-or-default-profile-picture-picture-id476085198?k=20&m=476085198&s=170667a&w=0&h=FXkT-N6vISLOCUefa9MyQg0pH-6loMX9zBZjgLK458c=" alt='#'/></article>
            <article>
